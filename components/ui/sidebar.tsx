...
export const SidebarLinkItem = ({
  ...
  return (
    <Link
      ...
      className={cn(
        "relative flex items-center gap-3 group/sidebar py-2.5 px-3 rounded-lg transition-colors duration-200",
  ...
  return (
    <div className={className}>
      ...
      <button
        ...
        className={cn(
          "flex items-center gap-3 w-full group/sidebar py-2.5 px-3 rounded-lg transition-colors duration-200",
          open ? "justify-start" : "justify-center",
