...
export default function HistoricoTransacoes({ transacoes }: HistoricoTransacoesProps) {
  const { t } = useI18n();
    ...
    <div className="bg-vaks-light-purple-card dark:bg-vaks-dark-purple-card rounded-2xl shadow-lg p-6 border border-vaks-light-purple-card-hover dark:border-vaks-dark-purple-card-hover">
      ...
      <div className="space-y-3 max-h-[600px] overflow-y-auto">
        {transacoes.map((transacao, index) => (
          <div
            key={transacao.id}
            className={`${getColorByType(transacao.tipo)} border p-4 rounded-lg hover:bg-gray-50 transition-colors`}
          >
