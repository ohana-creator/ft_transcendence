...
As rotas devem ser acessadas via **API Gateway (port 3000)**:
...
No clique do botão, redirecionar o browser para a rota do backend (via API Gateway):
...
- FRONTEND_URL=http://localhost:3000 (ou a porta real do frontend)
