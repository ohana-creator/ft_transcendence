      ...
      <div className="relative bg-gradient-to-br from-vaks-primary via-vaks-secondary to-vaks-cobalt text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-12">
          <div className="flex items-start justify-between mb-8">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl md:text-5xl font-black">Vaquinhas VAKS</h1>
              </div>
              <p className="text-lg md:text-xl text-white/90 max-w-2xl font-medium">
                Transforme sonhos em realidade. Crie campanhas, contribua para causas e faça a diferença na comunidade.
              </p>
              ...
              <div className="flex items-center gap-6 mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/80">Campanhas Ativas</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/80">VAKS Arrecadados</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative max-w-2xl">
            ...
            <input
              type="text"
              placeholder="Buscar vaquinhas por título, categoria ou organizador..."
              value={busca}
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Campanhas em Destaque</h3>
                <p className="text-gray-600 mb-4">
                  Explore as campanhas mais populares e apoiadas pela comunidade VAKS
                </p>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Todas as Campanhas</h2>
                <p className="text-sm text-gray-500">Mostrando 24 de 1.2K+ campanhas</p>
              </div>
        ...
        {activeTab === 'privadas' && (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-vaks-primary/5 to-vaks-secondary/5 rounded-2xl p-12 text-center border-2 border-dashed border-vaks-primary/20">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Suas Vaquinhas Privadas</h2>
              <p className="text-gray-600 mb-8 max-w-xl mx-auto">
                Crie campanhas privadas para alcançar seus objetivos com amigos, família ou grupos específicos
              </p>
              <button
                onClick={() => router.push('/vaquinhas/privadas/criar')}
