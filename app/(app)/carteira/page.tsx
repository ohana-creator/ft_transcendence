...
import {
  ...
  Shield, Clock, Sparkles, PlusCircle, Building2, Smartphone, ArrowUpRight, ArrowDownLeft,
} from 'lucide-react';
...
export default function CarteiraPage() {
  const { carteira, loading, atualizarCarteira } = useCarteira();
  const { t } = useI18n();
                  ...
                  <div className="rounded-3xl border border-vaks-light-stroke/30 bg-vaks-light-purple-card dark:border-vaks-dark-stroke/20 dark:bg-vaks-dark-purple-card shadow-md dark:shadow-vaks-dark-purple-card-hover p-8">
                    <div className="space-y-5">
                      <div>
                        ...
                        <input type="text" placeholder={cp.placeholder_destinatario} className="w-full rounded-2xl bg-vaks-light-input dark:bg-vaks-dark-input px-4 py-3.5 text-sm text-vaks-light-main-txt dark:text-vaks-dark-main-txt placeholder:text-vaks-light-alt-txt/50 dark:placeholder:text-vaks-dark-alt-txt/50 outline-none focus:ring-2 focus:ring-vaks-cobalt/30 dark:focus:ring-vaks-dark-secondary/30 transition-shadow" />
                      </div>
                      <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-3xl border border-vaks-light-stroke/30 bg-vaks-light-purple-card dark:border-vaks-dark-stroke/20 dark:bg-vaks-dark-purple-card shadow-md dark:shadow-vaks-dark-purple-card-hover p-8">
                    <div className="space-y-5">
                      ...
                      <button
                        disabled={!carregarMetodo || !carregarValor}
              ...
              {secao === 'historico' && (
                <div className="space-y-6">
                  ...
                  <div className="rounded-2xl border border-vaks-light-stroke/30 bg-vaks-light-purple-card dark:border-vaks-dark-stroke/20 dark:bg-vaks-dark-purple-card shadow-md dark:shadow-vaks-dark-purple-card-hover overflow-hidden">
                    <HistoricoTransacoes transacoes={carteira?.transacoes ?? []} />
                  </div>
                </div>
              )}
            </div>
