...
const blockchain_service_js_1 = require("./blockchain.service.js");
...
exports.BlockchainModule = BlockchainModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [blockchain_service_js_1.BlockchainService],
        exports: [blockchain_service_js_1.BlockchainService],
    })
], BlockchainModule);
