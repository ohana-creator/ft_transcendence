...
export class InvitationsController {
  ...
  accept(
    ...
    return this.campaignsService.respondInvitation(id, user.userId, user.username, true);
  }
  ...
  reject(
    ...
    return this.campaignsService.respondInvitation(id, user.userId, user.username, false);
  }
}
